...
/**
 * <a href="https://leetcode.com/problems/search-in-rotated-sorted-array-ii/">Problem description</a>
 */
public class Solved_Problem81SearchInRotatedSortedArray2 {
    public static void main(String[] args) {
        System.out.println(new Solution().search(new int[]{2, 5, 6, 0, 0, 1, 2}, 0)); // true
        System.out.println(new Solution().search(new int[]{2, 5, 6, 0, 0, 1, 2}, 3)); // false
    }
